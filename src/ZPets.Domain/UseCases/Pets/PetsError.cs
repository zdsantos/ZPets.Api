...
namespace ZPets.Domain.UseCases.Pets
{
    public static class PetsError
    {
        ...
        private static readonly string TutorNotFoundCode = "0004";
        ...
        public static class Message
        {
            ...
            public static readonly ErrorMessage TutorNotFound = new(Prefix + TutorNotFoundCode, "Tutor não encontrado");
